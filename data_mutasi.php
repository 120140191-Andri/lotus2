    ...
    ?>
        ...
        <div class="navcontainer">
            <div class="navleft">
                ...
                <h5 class="headnavigation2">Lotus <redfont>/</redfont> Mutasi <redfont>/</redfont> Data Mutasi </h5>
            </div>
        </div>
            ...
            <div class="dashcontainer1">
                <div class="detailcontainer" id="detailentry">
                   ...
                   <div class="entryfield">
					...
					<div class="entryfield">
                        <div class="formsubmit" style="position:absolute; bottom:-90px;" onclick="javascript:yesnoCheck();"><h5>Buat penerimaan Mutasi</h5>
                        </div><br><br>
                        <div class="formsubmit" style="position:absolute; bottom:-90px;" onclick="javascript:yesnoCheck();" name="yesno" id="yesCheck1"><h5><i class="fas fa-plus fas2"></i> Buat penerimaan Mutasi</h5></div> 
                    </div>
                    ...
                    <table id="tabel-data0">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;">Lokasi penerimaan</th>
                ...
                <div class="dcctable" id="dcctable">
                    <table id="tabel-data">
                       <div class="formsubmit" style="position:absolute; left:430px; z-index:50;" onclick="datalookup('detailentry'); datahide('dcctable');"><h5><i class="fas fa-plus fas2"></i> Buat Penerimaan Mutasi</h5></div>
                        <thead>
                            <tr>
                                <th>No. penerimaan Mutasi</th>
                        ...
                        <tr>
                            ...
                            <td>
                             <div class="formsubmit1 datalookup"><h5>Lihat</h5>
                            </div>
                            </td>
                        </tr>
                        <?php
	...
	<div id="modal-kotak1">
        ...
        <div id="bawah">
         ...
         <div class="detailcontainer" id="buatnomutasi">
                    <h3 class="headnavigation"><redfont><i class="fas fa-box-open"></i> Data Mutasi</redfont></h3>
                    <br>
                        <div class="entryfield">
