            ...
            <div class="dashcontainer1">
                ...
                <div class="dcctable" id="dcctable">
                    <table id="tabel-data">
                        ...
                        <tbody>
                        <?php
                            $material = mysqli_query($db,"select *, SUM(material_stok) as materialstock, MAX(material_hargabtt) as mthbtt from material where material_status != '2' group by material_barcode");
