    ...
    ?>
        ...
        <div class="navcontainer">
            <div class="navleft">
                ...
                <h5 class="headnavigation2">Lotus <redfont>/</redfont> Master <redfont>/</redfont> Bahan baku</h5>
            </div>
        </div>
        ...
        <hr class="hrred">
            <div class="dashcontainer1">
                <div class="detailcontainer" id="detailentry">
                    ...
                    <div class="entryfield">
                        <h5 class="headnavigation">Harga beli tertimbang <redfont><i>(Harus diisi)</i></redfont></h5>
                        ...
                        <h5 class="headnavigation">Harga beli terakhir <redfont><i>(Harus diisi)</i></redfont></h5>
                ...
                <div class="dcctable" id="dcctable">
                    <table id="tabel-data">
                        <div class="formsubmit" style="position:absolute; float:right; z-index:50;" onclick="datalookup('detailentry'); datahide('dcctable');"><h5><i class="fas fa-plus fas2"></i> Tambah data bahan baku</h5></div>
                        <thead>
                            <tr>
                                <th>Barcode</th>
                        ...
                        <tbody>
                        <?php
                            $material = mysqli_query($db,"select * from material");
                        ...
                        <tr>
                            ...
                            <td><div style="float:left; margin-right:10px;"><?php echo $row['material_stok'];?> pcs</div> <h5 class="headnavigation" style="float:left;"></h5></td>
                ...
                <div class="detailcontainer" id="detailbox">
                    <h3 class="headnavigation"><redfont><i class="fas fa-box-open"></i> Data bahan baku lengkap</redfont></h3>
                    <br>
                    <div class="entryfield">
                        <h5 class="headnavigation">Kode barcode</h5>
                        <h2 class="headnavigation"><redfont id="barcode_view">barcode</redfont></h2><br><br>
                        <h5 class="headnavigation">Nama bahan baku</h5>
                        ...
                        <h5 class="headnavigation">Stok bahan baku</h5>
                        <h2 class="headnavigation"><redfont id="stock_view">stok</redfont> <REDFONT>pcs</REDFONT></h2><br><br>
                        <h5 class="headnavigation">Asal supplier</h5>
                        <h2 class="headnavigation"><redfont id="supplier_view">supplier</redfont></h2><br><br>
                    </div>
                    <div class="entryfield">
                        <h5 class="headnavigation">Panjang bahan baku</h5>
                        <h2 class="headnavigation"><redfont id="panjang_view">panjang</redfont> <redfont><?php if ($usersettingplt === 'M'){echo '<redfont>Meter</redfont>';}else{echo '<redfont>Centimeter</redfont>';};?></redfont></h2><br><br>
                        <h5 class="headnavigation">Lebar bahan baku</h5>
                        <h2 class="headnavigation"><redfont id="lebar_view">lebar</redfont> <redfont> <?php if ($usersettingplt === 'M'){echo '<redfont>Meter</redfont>';}else{echo '<redfont>Centimeter</redfont>';};?></redfont></h2><br><br>
                        <h5 class="headnavigation">Tinggi bahan baku</h5>
                        <h2 class="headnavigation"><redfont id="tinggi_view">tinggi</redfont> <redfont> <?php if ($usersettingplt === 'M'){echo '<redfont>Meter</redfont>';}else{echo '<redfont>Centimeter</redfont>';};?></redfont></h2><br><br>
                        <h5 class="headnavigation">Berat bahan baku</h5>
                        <h2 class="headnavigation"><redfont id="berat_view">berat</redfont> <redfont><?php if ($usersettingb === 'KG'){echo '<redfont>Kilogram</redfont>';}else{echo '<redfont>Gram</redfont>';};?></redfont></h2><br><br>
                    </div>
                    <div class="entryfield">
                        <h5 class="headnavigation">Harga beli tertimbang</h5>
                        <h2 class="headnavigation"><redfont>Rp.</redfont><redfont id="hbtt_view">harga</redfont></h2><br><br>
                        <h5 class="headnavigation">Harga beli terakhir</h5>
                        <h2 class="headnavigation"><redfont>Rp.</redfont><redfont id="hbtr_view">harga</redfont></h2><br><br>
                        <h5 class="headnavigation">Lokasi bahan baku</h5>
                        <h2 class="headnavigation"><redfont id="lokasi_view"></redfont></h2><br><br>
                    ...
                    <div class="konfirmasi" style="position:absolute; bottom:0; right:0;">
                        ...
                        <div class="formsubmit editbox" onclick="datahide('detailbox'); datalookup('detailedit');"><h5>Ubah data bahan baku</h5></div>
                ...
                <div class="detailcontainer" id="detailedit">
                    ...
                    <form class="boxedit" action="library/update_material.php" method="post">
                        <div class="entryfield">
                            ...
                            <h5 class="headnavigation">Barcode bahan baku <redfont><i>(Harus diisi)</i></redfont></h5>
